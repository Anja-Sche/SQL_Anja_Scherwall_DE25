-- create operation using the INSERT statement (adds new data, define new database objects) 
...
VALUES
    (
        'query',
        'request made ta a database to retrive, modify or manipulate data'
    );
...
VALUES
    ...
    ('tuple', 'imutable, works similar to lists, alsostore records');
